...
def main():
    ...
    parser.add_argument(
        "--port", type=int, default=8000, help="Port sur lequel exécuter l'application (défaut: 8000)"
    )
    parser.add_argument(
        "--host", type=str, default="127.0.0.1", help="Hôte sur lequel exécuter l'application (défaut: 127.0.0.1)"
    )
    parser.add_argument(
